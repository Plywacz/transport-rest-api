...
public class RangeReportDeserialization extends StdDeserializer<RangeReportDto> {
    public RangeReportDeserialization() {
        this(null);
    }

    public RangeReportDeserialization(Class<?> vc) {
        super(vc);
    }
